...
exports.create = function (options, callback) {
  ...
  function spawnPhantom (callback) {
	...
	Object.keys(options.parameters).forEach(function (parm) {
      ...
      //args = "slimerjs --output-encoding=utf8 --script-encoding=utf8 /home/pharzan/dev/www/testTube/node_modules/node-phantom-simple/bridge.js ";
  ...
  spawnPhantom(function (err, phantom, port) {
    ...
    var setup_new_page = function (id) {
      var methods = [
        ...
        'switchToFrame', 'switchToChildFrame', 'switchToChildFrame', 'switchToMainFrame',
          'switchToParentFrame', 'uploadFile', 'clearMemoryCache','captureContent'
      ];
	...
	if(args[0]==='captureContent'){
	  //  args[1]=[/text\/plain/,/text\/html/]
    ...
    var proxy = {
      process: phantom,
  // 	captureContent: function(expression,callback){
  // 	    request_queue.push([ [ 0, 'setCaptureContent', expression ], callbackOrDummy(callback, poll_func) ]);
  // },

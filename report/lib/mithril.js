var m = (function app(window, undefined) {
    ...
    function unload(cached) {
        ...
        if (cached.controllers) {
            forEach(cached.controllers, function(controller) {
                if (isFunction(controller.onunload)) controller.onunload({
                    preventDefault: noop
                });
            });
        }
    ...
    m.mount = m.module = function(root, component) {
        ...
        if (!isPrevented) {
            ...
            m.startComputation();
            roots[index] = root;
            var currentComponent = component ? (topComponent = component) : (topComponent = component = {
                controller: noop
            });

...
const footerButtons = [
	...
	events:{onclick:function(){
		 ...
		 data: JSON.stringify({command:"loadDatabase",
				       dbName:dropDown.selected})
	     }).then(function(r) {
		 console.log(r);
			 ...
			 content: m.component(list, {
				 ...
				 m.component(listTile, {
					 ...
					 onclick:function(){
						 ...
						 background: true,
						 dataType: 'application/json',
						 data: JSON.stringify({command:"getDataBaseList"})
					     }).then(function(r) {
						 console.log(r.response);
						 dropDown.update(r.response);
					     });
